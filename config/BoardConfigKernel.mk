...
#
#   TARGET_KERNEL_CLANG_COMPILE        = Compile kernel with clang, defaults to true#                                        generates dtbo.img. Defaults to dtbo.img
...
#                                        generates the *.dtb targets. Defaults to dtb
#
